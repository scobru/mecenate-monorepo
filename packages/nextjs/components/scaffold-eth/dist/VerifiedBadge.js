...
var utils_1 = require("ethers");
var Address_1 = require("./Address");
function VerifiedBadge(_a) {
  var _this = this;
  var verified = _a.verified,
    encryptedVaultId = _a.encryptedVaultId,
    address = _a.address;
  var _b = react_1.useState(0),
    depositedBalance = _b[0],
    setDepositedBalance = _b[1];
  var chain = wagmi_1.useNetwork().chain;
  var deployedContractWallet = utilsContract_1.getDeployedContract(
    chain === null || chain === void 0 ? void 0 : chain.id.toString(),
    "MecenateVault",
  );
  ...
  var getDeposit = react_1.useCallback(
    function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                wallet === null || wallet === void 0 ? void 0 : wallet.getEthDeposit(encryptedVaultId),
              ];
            case 1:
              tx = _a.sent();
              if (tx) setDepositedBalance(Number(utils_1.formatEther(tx)));
              _a.label = 2;
            case 2:
              return [3 /*break*/, 4];
            case 3:
  ...
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(
      ...
      {
        className:
          "inline-flex items-start max-w-fit border-1 p-1 rounded-lg bg-gradient-to-t border-slate-700 shadow-md shadow-slate-600",
      },
      react_1["default"].createElement(
        "span",
