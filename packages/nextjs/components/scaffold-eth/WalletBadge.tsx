...
export default function WalletBadge() {
  ...
  const museContract = new ethers.Contract(
        ...
        <Link href="/connect">
          ...
          {signerAddress && (
            <Blockies
              ...
              seed={String(signerAddress) as string}
            />
          )}
        </Link>
          ...
          <div className="p-4">
            <div className="flex justify-between">
              <span>
                {signerAddress != null && (
                  <Address
                    address={String(signerAddress) as string}
                    format="short"
                  />
                )}
              </span>
