...
import { useIsMounted } from "../../hooks/lit/useIsMounted";
...
const WalletMethods = ({ authWithEthWallet, setView }: WalletMethodsProps) => {
  ...
  return (
    <>
      ...
      <p>Connect your wallet then sign a message to verify you&apos;re the owner of the address.</p>
          ...
          >
            {connector.name.toLowerCase() === "metamask" && (
              <div className="btn__icon">
                <Image src="/metamask.png" alt="MetaMask logo" fill={true}></Image>
              </div>
            )}
            {connector.name.toLowerCase() === "coinbase wallet" && (
              <div className="btn__icon">
                <Image src="/coinbase.png" alt="Coinbase logo" fill={true}></Image>
              </div>
            )}
