...
export default function AccountSelection({ accounts, setCurrentAccount, error }: AccountSelectionProp) {
        ...
        <form onSubmit={handleSubmit} className="form">
          ...
          >
            {accounts.map((account, index) => (
              ...
              >
                <RadioGroup.Item className="account-item__radio" value={index.toString()} id={account.ethAddress}>
                  {" "}
                  <RadioGroup.Indicator className="account-item__indicator" />
                </RadioGroup.Item>
                <label className="account-item__label" htmlFor={account.ethAddress}>
