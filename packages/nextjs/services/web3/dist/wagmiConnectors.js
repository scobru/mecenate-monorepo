 ...
 * Chains for the app
 */
exports.appChains = wagmi_1.configureChains(enabledChains, [
...
], __assign({ stallTimeout: 3000 }, (process.env.NEXT_PUBLIC_NETWORK !== "hardhat"
    ? {
 ...
 */
exports.burnerChains = wagmi_1.configureChains([chains.hardhat], [
    alchemy_1.alchemyProvider({
        // ToDo. Move to .env || scaffold config
        // This is ours Alchemy's default API key.
        // You can get your own at https://dashboard.alchemyapi.io
