...
var Vault = function () {
    ...
    var _g = react_1["default"].useState(), signature = _g[0], setSignature = _g[1];
    var _h = react_1["default"].useState(0), amount = _h[0], setAmount = _h[1];
    var _j = react_1["default"].useState(0), depositedBalance = _j[0], setDepositedBalance = _j[1];
    var _k = react_1["default"].useState(""), to = _k[0], setTo = _k[1];
    var _l = react_1["default"].useState(null), sismoData = _l[0], setSismoData = _l[1];
    var _m = react_1["default"].useState(null), verified = _m[0], setVerified = _m[1];
    var _o = react_1["default"].useState(null), sismoResponse = _o[0], setSismoResponse = _o[1];
    var store = store_1.useAppStore();
    var _p = react_1["default"].useState(""), tokenAddress = _p[0], setTokenAddress = _p[1];
    var _q = react_1["default"].useState(""), userCommitment = _q[0], setUserCommitment = _q[1];
    var _r = react_1["default"].useState(""), randomBytes32Hash = _r[0], setRandomBytes32Hash = _r[1];
    var _s = react_1["default"].useState(0), nonce = _s[0], setNonce = _s[1];
    var _t = react_1["default"].useState(""), withdrawalAddress = _t[0], setWithdrawalAddress = _t[1];
    var walletAddress;
    var walletAbi = [];
    ...
    var walletRelayer = wagmi_1.useContract({
        address: walletAddress,
        abi: walletAbi,
        signerOrProvider: customWallet
    });
    var getDeposit = function () { return __awaiter(void 0, void 0, void 0, function () {
        var tx;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!sismoData) return [3 /*break*/, 2];
                    return [4 /*yield*/, (wallet === null || wallet === void 0 ? void 0 : wallet.getEthDeposit(utils_js_1.keccak256((_a = sismoData === null || sismoData === void 0 ? void 0 : sismoData.auths[0]) === null || _a === void 0 ? void 0 : _a.userId)))];
                case 1:
                    tx = _b.sent();
                    if (tx)
                        setDepositedBalance(Number(utils_js_1.formatEther(tx)));
                    _b.label = 2;
    ...
    react_1.useEffect(function () {
        ...
        var interval = setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getDeposit()];
                    case 1:
                        _a.sent();
    ...
    var deposit = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (wallet === null || wallet === void 0 ? void 0 : wallet.depositETH(utils_js_1.keccak256(sismoData.auths[0].userId), {
    ...
    var withdraw = function () { return __awaiter(void 0, void 0, void 0, function () {
        var iface;
        return __generator(this, function (_a) {
            iface = new ethers_1.ethers.utils.Interface(deployedContractWallet === null || deployedContractWallet === void 0 ? void 0 : deployedContractWallet.abi);
            txData(walletRelayer === null || walletRelayer === void 0 ? void 0 : walletRelayer.withdrawETH(utils_js_1.parseEther(String(amount)), sismoResponse, withdrawalAddress, nonce));
            return [2 /*return*/];
        });
    }); };
    // Nuove funzioni per gestire i token ERC20
    var depositToken = function (tokenAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var tx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (wallet === null || wallet === void 0 ? void 0 : wallet.depositToken(tokenAddress, utils_js_1.parseEther(String(amount)), sismoResponse))];
                case 1:
                    tx = _a.sent();
                    if (tx === null || tx === void 0 ? void 0 : tx.hash) {
    ...
    var withdrawToken = function (tokenAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var tx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (wallet === null || wallet === void 0 ? void 0 : wallet.withdrawToken(tokenAddress, to, utils_js_1.parseEther(String(amount)), sismoResponse))];
                case 1:
                    tx = _a.sent();
                    if (tx === null || tx === void 0 ? void 0 : tx.hash) {
    ...
    var getDepositToken = function (tokenAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var commitment, tx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    commitment = userCommitment || utils_js_1.keccak256(sismoData.auths[0].userId);
                    if (!commitment) return [3 /*break*/, 2];
                    return [4 /*yield*/, (wallet === null || wallet === void 0 ? void 0 : wallet.getTokenDeposit(tokenAddress, commitment))];
                case 1:
                    tx = _a.sent();
                    if (tx) {
    ...
    function generateRandomBytes32() {
        ...
        scaffold_eth_1.notification.warning(react_1["default"].createElement("div", { id: "alert-additional-content-3", className: "p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800", role: "alert" },
            react_1["default"].createElement("div", { className: "flex items-center" },
                ...
                react_1["default"].createElement("h3", { className: "text-lg font-medium" }, "Save Commitment!")),
    ...
    return (react_1["default"].createElement("div", { className: "flex min-w-fit flex-col mx-auto flex-grow pt-10 text-base-content p-4 m-4 " },
        react_1["default"].createElement("div", { className: "max-w-3xl text-center my-2 text-base-content" },
            react_1["default"].createElement("div", { className: "flex flex-col min-w-fit mx-auto items-center mb-5" },
                react_1["default"].createElement("div", { className: "max-w-3xl text-center" },
                    react_1["default"].createElement("h1", { className: "text-6xl font-bold mb-8" }, "Vault"),
                    react_1["default"].createElement("p", { className: "text-2xl  mb-5" }, "Where Zero-Knowledge Proofs Meet Secure Deposits."),
                    react_1["default"].createElement("p", { className: "text-xl  mb-10" }, wallet === null || wallet === void 0 ? void 0 : wallet.address)),
                react_1["default"].createElement("div", { className: "flex flex-col min-w-fit mx-auto items-center mb-5" },
                    react_1["default"].createElement("div", { className: "max-w-3xl text-center" },
                        react_1["default"].createElement("button", { className: "btn w-full p-2 border rounded-md shadow-sm bg-primary-500 hover:bg-primary-700", onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                ...
                react_1["default"].createElement("div", { className: "p-4 " },
                    react_1["default"].createElement("div", { className: "w-full" },
                        react_1["default"].createElement("div", { className: "card card-bordered border-2 bg-secondary my-10 p-10 w-fit mx-auto flex flex-col  text-left" },
                            depositedBalance && wallet && (react_1["default"].createElement("p", { className: "text-left text-lg mb-5" },
                                "Balance: ",
                                depositedBalance,
                                " ETH")),
                            react_1["default"].createElement("span", { className: "text-base font-semibold my-5 " }, "Deposit"),
                            react_1["default"].createElement("div", { className: "w-full mb-5" },
                                react_1["default"].createElement("input", { type: "text", className: "input input-bordered w-80", placeholder: "Amount to Deposit", onChange: function (e) { return setAmount(Number(e.target.value)); } })),
                            react_1["default"].createElement("div", { className: "w-full mb-5" },
                                react_1["default"].createElement("button", { className: "btn w-full p-2 border rounded-md shadow-sm bg-primary-500 hover:bg-primary-700", onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    if (!tokenAddress) return [3 /*break*/, 2];
                                                    return [4 /*yield*/, depositToken(tokenAddress)];
                                                case 1:
                                                    _a.sent();
                                                    return [3 /*break*/, 4];
                                                case 2: return [4 /*yield*/, deposit()];
                                                case 3:
                                                    _a.sent();
                                                    _a.label = 4;
                                    ...
                                    }); }, disabled: sismoResponse != null ? false : true }, "Deposit")),
                            react_1["default"].createElement("span", { className: "text-base font-semibold my-2 " }, "Withdraw"),
                            react_1["default"].createElement("div", { className: "w-full mb-5" },
                                react_1["default"].createElement("input", { type: "text", className: "input input-bordered w-full", placeholder: "Amount to Withdraw", onChange: function (e) { return setAmount(Number(e.target.value)); } })),
                            react_1["default"].createElement("div", { className: "w-full" },
                                react_1["default"].createElement("button", { className: "btn w-full p-2 border rounded-md shadow-sm bg-primary-500 hover:bg-primary-700", onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    if (!tokenAddress) return [3 /*break*/, 2];
                                                    return [4 /*yield*/, withdrawToken(tokenAddress)];
                                                case 1:
                                                    _a.sent();
                                                    return [3 /*break*/, 4];
                                                case 2: return [4 /*yield*/, withdraw()];
                                                case 3:
                                                    _a.sent();
                                                    _a.label = 4;
                                                case 4: return [2 /*return*/];
                                    ...
                                    }); }, disabled: sismoResponse != null ? false : true && !withdrawalAddress && !nonce }, "Withdraw")))))))));
};
