...
const Home: NextPage = () => {
  const deployedContractStats = getDeployedContract(
      ...
      <div className="flex w-screen items-center flex-col rounded-sm bg-gradient-to-tl from-blue-950 to-slate-950 ">
        <div className="w-full p-5  bg-fixed bg-cover bg-center mx-auto ">
              ...
              <div className="flex-wrap items-center min-w-fit  lg:text-3xl md:text-4xl text-xl ">
                <div className="stats  mx-2 min-w-fit bg-inherit  ">
                  <div className="stat gap-3">
                    <div className="stat-title  lg:text-3xl md:text-4xl text-xl  ">
                      TREASURY
                    </div>
                    <div className="stat-value lg:text-3xl md:text-4xl text-xl font-number ">
                      {String(
                        Number(Number(stats.treasuryBalance) / 1e18).toFixed(3),
                      )}{' '}
                      ETH
                    </div>
                    <div className="stat-desc  text-base">
                      earned across all fee&apos;s product.
                    </div>
                  </div>
                </div>
                <div className="stats  mx-2 min-w-fit bg-inherit ">
                  <div className="stat gap-3 ">
                    ...
                    <div className="stat-desc text-base ">
                      {' '}
                      Percent Protocol Fee
                    </div>
                  </div>
                </div>
                <div className="stats  mx-2 min-w-fit bg-inherit">
                  <div className="stat gap-3">
                    <div className="stat-title font-bold lg:text-3xl md:text-4xl text-xl  ">
                      TAX
                    </div>
                    <div className="stat-value lg:text-3xl md:text-4xl text-xl font-number">
                      {' '}
          ...
          <div className="flex gap-10 mt-5 mx-auto text-center w-fit my-10 p-5 opacity-90 rounded-lgjustify-between justify-self-auto">
            ...
            <Link
              href="https://github.com/scobru/mogu"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <div className="w-screen bg-doors bg-cover bg-fixed ">
          <div className="xl:w-6/12 md:8/12 lg:10/12 sm:12/12 mx-auto bg-gradient-to-br from-blue-950 to-slate-800 opacity-95 ">
            <div className="p-10 my-20 w-screen">
              ...
              <ol className="list-decimal ml-4 px-8 text-xl font-extralight">
                ...
                <li>
                  Connect with Sismo to generate your Zero-Knowledge Proof (ZKP)
                </li>
                <li>Create your key pair and sign in</li>
                <li>
                  Set up your seller feed or browse requests in the marketplace
                </li>
              </ol>
            </div>
          </div>
          <div className="max-w-3xl my-5 bg-gradient-to-br from-blue-950 to-slate-700 p-10 flex-col mx-auto text-center  text-base-content">
            <h1 className="text-7xl font-extrabold mb-20 font-heading">
            ...
            <p className="text-3xl mb-20 font-extralight text-left  hover:text-base-content font-heading ">
              <strong>Mecenate Feeds </strong> allows me to securely and
              privately post my information and receive payments directly from
              interested parties without any intermediaries.
            </p>
            <p className="text-2xl mb-8 font-thin text-left hover:text-base-content">
              With Mecenate Protocol, I can be confident that my information is
              protected and that I&apos;m getting fair compensation for it.
            </p>
          </div>
        </div>
            ...
            <div className="p">
              <div className="font-base align-baseline text-justify-center my-5">
                ...
                <ul className="text-xl font-light">
                  A Place where any Buyer can ask for any information and data
                  for the right price.
                  <br />
                  <br />
        ...
        <div className="w-screen p-5 bg-cyborg bg-fixed">
          <div className="flex p-5 flex-col bg-gradient-to-tl from-blue-950 to-slate-900 opacity-95 items-center text-center py-10 xl:w-6/12 md:8/12 lg:10/12 sm:12/12 mx-auto ">
            <ArrowPathRoundedSquareIcon className="h-20 w-20 fill-secondary" />
            <div className="p">
              <div className="font-base align-baseline text-justify-center my-5">
                <ul>
                  <div className="text-6xl font-extrabold mb-5">MARKET</div>
                </ul>
                <br />
                <ul className="text-xl font-light">
                  An open marketplace for information of any kind. It can be
                  used to create credible signals over possession of local
                  knowledge and attract a buyer willing to pay for it.
                  <br />
                  <br />
                  <strong>Mecenate MARKET</strong> is build on top of:
                  <br />
                  <br />
                  <Square3Stack3DIcon className="h-8 w-8 fill-secondary mx-auto" />
                  <strong>Mecenate FEEDS</strong>
        ...
        <div className="w-screen p-5 bg-cyborg bg-fixed">
          <div className="flex p-5 flex-col bg-gradient-to-tl from-blue-950 to-slate-900 opacity-95 items-center text-center py-10 xl:w-6/12 md:8/12 lg:10/12 sm:12/12 mx-auto ">
            <BoltIcon className="h-20 w-20 fill-secondary" />
            <div className="p">
              <div className="font-base align-baseline text-justify-center my-5">
                <ul>
                  <div className="text-6xl font-extrabold mb-5">SEND</div>
                </ul>
                <br />
                <ul className="text-xl font-light">
                  <strong>Send Stealth Payments.</strong>
        ...
        <div className="w-screen  bg-center ">
          <div className="flex flex-col xl:w-6/12 md:8/12 lg:10/12 sm:12/12  p-10  text-left  my-5  bg-gradient-to-bl from-slate-800 to-slate-950 opacity-95 mx-auto">
            <h1 className="text-4xl font-extrabold mb-8 text-left ">
              INFORMATIONS FINDS YOU 🔮
            </h1>
            <p className="text-2xl  mb-8">
              {' '}
              Lock up a cryptocurrency reward. Anyone in the world can fulfill
              it. They must stake cryptocurrency and upload a file containing
              the requested information.
            </p>
            <p className="text-3xl  mb-8">
              Release the reward if you are satisfied with the upload. Destroy
              their stake if you are dissatisfied 🔥
            </p>
            <p className="text-2xl  mb-8">
              Mecenate Bay is decentralized, encrypted, and unstoppable. All
              requests are public.
            </p>
        ...
        <div className="w-screen backdrop-opacity-50 backdrop-blur-2xl bg-bazaar bg-cover bg-fixed">
          <div className="flex flex-col xl:w-6/12 md:8/12 lg:10/12 sm:12/12  p-10  text-left  my-5  bg-gradient-to-bl from-slate-800 to-slate-950 opacity-95 mx-auto">
            ...
            <p className="text-xl  mb-8">
              <strong>Question</strong> Enter a short explanation of what
              you&apos;re looking for. This can include links, Twitter handles
              and hastags. Make your descriptions as clear as possible.
            </p>
            <p className="text-xl  mb-8">
              <strong>Reward</strong> An amount of ETH cryptocurrency you are
              locking up as a reward. This will be transferred into an escrow
              when you make the request, you make sure you have this in your
              wallet. Like this fulfillers can see you really have the money and
              will take your request seriously. (Once someone fulfills your
              request it is added to their stake and you will not get it back,
              you can only punish it.)
            </p>
            <p className="text-xl  mb-8">
              <strong>Fulfiller</strong> stake This is what makes Mecenate Bay
              powerful. This is how much ETH cryptocurrency someone will need to
              deposit when fulfilling your request. You can destroy a fraction
              or all of their staked money if you are dissatisfied with what
              they provide. This will stop people responding with spam or bad
              information. It usually makes sense to have this be roughly 10% -
              50% of the reward.
            </p>
            <p className="text-xl  mb-8">
              <strong> Punish ratio</strong> How many ETH it will cost you to
              destroy one dollar of the fulfiller&apos;s stake. For example; if
              you set the ratio to 0.1 and punish a fulfiller who staked 100
              ETH, it will cost you 10 ETH to destroy their entire stake. This
              protects the fulfiller from reckless punishment. The default value
              is good for most requests.
            </p>
            <p className="text-xl  mb-8">
              <strong>Punish period</strong> How many days after your request is
              fulfilled you have to verify the quality of the information
              provided. Within this window, you may punish the fulfiller. After
              this time their stake and reward are released. You may decide to
              release it early if you are satisfied with the submission. The
