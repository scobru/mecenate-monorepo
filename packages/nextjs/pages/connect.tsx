...
const clientId =
  'BNtxg-XlYHBoZ0hMJtxcVx0t23BVW8ndPR2QSLusYQmU1kFJZwvps8WxTXxNJOKuHorgaBk0f1d8mZl0JlHwUgI'; // get from https://dashboard.web3auth.io
    ...
    const init = async () => {
      try {
        ...
        web3auth.configureAdapter(
          torusWalletAdapter as unknown as IAdapter<unknown>,
        );
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen font-heading no-border bg-gradient-to-tl from-blue-950 to-slate-950 ">
      <h1 className="text-4xl mb-3 font-light text-white   text-center">
        YOUR ETHEREUM ADDRESS WITH YOUR SOCIAL ACCOUNT
      </h1>
      <h1 className="text-lg  mb-8  font-light text-white  text-center ">
        Use your favourite web3 wallet or social account to create your EVM
        address
      </h1>
