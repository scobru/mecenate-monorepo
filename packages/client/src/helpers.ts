...
/* const publicKeyU8a = Uint8Array.prototype.slice.call(publicKey, 0, 32);
const secretKeyU8a = Uint8Array.prototype.slice.call(secretKey, 0, 32); */
