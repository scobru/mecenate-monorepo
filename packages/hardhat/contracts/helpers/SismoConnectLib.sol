...
contract SismoConnect {
    ...
    function buildConfig(
        ...
        return
            SismoConnectConfig({
                appId: appId,
                vault: buildVaultConfig(isImpersonationMode)
            });
    }
  ...
  function verify(
   ...
   function buildClaim(
    ...
    function buildClaim(
        ...
        return
            _claimRequestBuilder.build(groupId, isOptional, isSelectableByUser);
    }
  ...
  /* 
    ...
    function buildRequest(
        ...
        return
            _requestBuilder.build(auth, claim, _GET_EMPTY_SIGNATURE_REQUEST());
    }
