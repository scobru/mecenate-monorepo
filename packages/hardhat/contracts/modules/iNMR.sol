...
abstract contract iNMR {
  ...
  function transfer(address _to, uint256 _value) external virtual returns (bool ok);

  function transferFrom(
    address _from,
    address _to,
    uint256 _value
  ) external virtual returns (bool ok);

  function approve(address _spender, uint256 _value) external virtual returns (bool ok);
  ...
  function mint(uint256 _value) external virtual returns (bool ok);
  ...
  function numeraiTransfer(address _to, uint256 _value) external virtual returns (bool ok);
}
